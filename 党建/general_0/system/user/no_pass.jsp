...
function newAccount(){
 window.close();
 popWin("editNew.jsp?id=11nliiyez8lnq");
}
function warn(way){
  if(way == "mail"){
     centWin("/general_0/webmail/new.jsp?users=11nliiyez8lnq&temp=UserAccountToEmail&subject=用户帐号通知",730,600);
  }else if(way == "phone"){
    centWin("/general_0/mobile/send/edit.jsp?users=11nliiyez8lnq&temp=UserAccountToMobile",700,430);
  }
	...
	var userLoginId = "jzcgly"
	if(userLoginId != "null"){
		 document.myForm.phoneUrl.value = "/general_0/mobile/send/edit.jsp?users=11nliiyez8lnq&temp=UserAccountToMobile";
  		 document.myForm.emailUrl.value = "/general_0/webmail/new.jsp?users=11nliiyez8lnq&temp=UserAccountToEmail&subject=用户帐号通知";
		 //myForm.submit();
	}
	</script>
</html>
