...
function newAccount(){
 window.close();
 popWin("editNew.jsp?id=1l01k3lge1hc");
}
function warn(way){
  if(way == "mail"){
     centWin("/general_0/webmail/new.jsp?users=1l01k3lge1hc&temp=UserAccountToEmail&subject=用户帐号通知",730,600);
  }else if(way == "phone"){
    centWin("/general_0/mobile/send/edit.jsp?users=1l01k3lge1hc&temp=UserAccountToMobile",700,430);
  }
	...
	var userLoginId = "15996107536"
	if(userLoginId != "null"){
		 document.myForm.phoneUrl.value = "/general_0/mobile/send/edit.jsp?users=1l01k3lge1hc&temp=UserAccountToMobile";
  		 document.myForm.emailUrl.value = "/general_0/webmail/new.jsp?users=1l01k3lge1hc&temp=UserAccountToEmail&subject=用户帐号通知";
		 //myForm.submit();
	}
	</script>
</html>
